            ...
            {(coverAsset || existingImageUrl) ? (
              <View className="bg-white rounded-xl border border-zinc-100 overflow-hidden mb-4">
                ...
                <View className="flex-row border-t border-zinc-100">
                  <TouchableOpacity onPress={pickCoverImage} className="flex-1 py-3 items-center border-r border-zinc-100">
              ...
              <TouchableOpacity
                ...
                className="bg-white rounded-xl border border-zinc-100 overflow-hidden mb-4 items-center justify-center py-8"
              >
