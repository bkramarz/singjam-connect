-- Add in_set boolean to jam_shared_songs so the jam view can immediately show
-- which shared songs are already in the linked set list, without a separate fetch.
