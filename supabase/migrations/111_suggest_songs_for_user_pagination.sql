-- Migration 111: add p_offset parameter to suggest_songs_for_user for pagination.
-- Drop the old 2-param signature first to avoid ambiguous overloads.

DROP FUNCTION IF EXISTS public.suggest_songs_for_user(uuid, int);
